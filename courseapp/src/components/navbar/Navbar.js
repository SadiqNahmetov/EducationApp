        ...
        <nav className="main_nav_container">
          <div className="main_nav">
            <ul className="main_nav_list">
              ...
              <li className="main_nav_item">  <Link className="navColor" to="/about">Courses</Link></li>
              <li className="main_nav_item">  <Link className="navColor" to="/about">Elements</Link></li>
              <li className="main_nav_item">  <Link className="navColor" to="/about">News</Link></li>
              <li className="main_nav_item">  <Link className="navColor" to="/about">Contact</Link></li>
            </ul>
          </div>
        </nav>
      </div>
